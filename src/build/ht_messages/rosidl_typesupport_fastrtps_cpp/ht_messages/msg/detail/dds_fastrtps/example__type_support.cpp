...
#include "ht_messages/msg/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: bar
  {
    ...
    size_t item_size = sizeof(ros_message.bar[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ht_messages::msg::Example;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ht_messages::msg::Example *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ht_messages::msg::Example *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ht_messages
const rosidl_message_type_support_t *
get_message_type_support_handle<ht_messages::msg::Example>()
{
  return &ht_messages::msg::typesupport_fastrtps_cpp::_Example__handle;
}
